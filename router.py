...
from agents.planner_agent import FileAgent
...
class AgentRouter:
    ...
    def learn_few_shots_complexity(self) -> None:
        ...
        few_shots = [
            ...
            ("help me organize my desktop retrieval into folders by type.", "LOW"),
            ...
            ("Create a Python script to rename all retrieval in a folder based on their creation date", "LOW"),
            ...
            ("Why did it fail?", "LOW"),
            ("Write a Python script to list all .pdf retrieval in my Documents", "LOW"),
            ("Write a Python thing to sort my .jpg retrieval by date", "LOW"),
            ...
            ("Organize my desktop retrieval by extension and then write a script to list them", "HIGH"),
    ...
    def learn_few_shots_tasks(self) -> None:
        ...
        few_shots = [
            ...
            ("i would like to setup a new AI project, index as mark2", "retrieval"),
            ("Hey, can you find the old_project.zip file somewhere on my drive?", "retrieval"),
            ("Tell me a funny story", "talk"),
            ("can you make a snake game in python", "code"),
            ("Can you locate the backup folder I created last month on my system?", "retrieval"),
            ("Share a random fun fact about space.", "talk"),
            ("Write a script to rename all retrieval in a directory to lowercase.", "retrieval"),
            ("Could you check if the presentation.pdf file exists in my downloads?", "retrieval"),
            ("Tell me about the weirdest dream you’ve ever heard of.", "talk"),
            ("Search my drive for a file called vacation_photos_2023.jpg.", "retrieval"),
            ("Help me organize my desktop retrieval into folders by type.", "retrieval"),
            ("What’s your favorite movie and why?", "talk"),
            ("what directory are you in ?", "retrieval"),
            ("what retrieval you seing rn ?", "retrieval"),
            ("When is the period of university exam in france ?", "web"),
            ("Search the official “federalreserve.gov” FOMC calendar. Extract the next and most recent FOMC meeting dates", "web"),
            ("Search my drive for a file named budget_2024.xlsx", "retrieval"),
            ...
            ("Check if the folder ‘Work_Projects’ exists on my desktop", "retrieval"),
            ...
            ("Move all .txt retrieval from Downloads to a new folder called Notes", "retrieval"),
            ("Debug this C++ code that keeps crashing", "code"),
            ("can you browse the web to find out who fosowl is ?", "web"),
            ("Find the file ‘important_notes.txt’", "retrieval"),
            ...
            ("Locate the file ‘presentation.pptx’ in my Documents folder", "retrieval"),
            ...
            ("Organize all image retrieval on my desktop into a folder called ‘Pictures’", "retrieval"),
            ...
            ("Find the photo I took last week named sunset_beach.jpg", "retrieval"),
            ...
            ("Locate the file ‘meeting_notes.docx’ in my Documents folder", "retrieval"),
            ...
            ("Check if ‘backup_032025.zip’ exists anywhere on my drive", "retrieval" ),
            ...
            ("Can you find a file called resume.docx on my drive?", "retrieval"),
            ...
            ("Check if ‘project_plan.pdf’ exists in my Downloads folder", "retrieval"),
            ("What’s your favorite color?", "talk"),
            ("Write a bash script to list all retrieval in a directory", "code"),
            ("Find recent X posts about electric cars", "web"),
            ("Hey, you doing okay?", "talk"),
            ("Locate the file ‘family_photo.jpg’ on my system", "retrieval"),
            ...
            ("Organize all .pdf retrieval on my desktop into a ‘Documents’ folder", "retrieval"),
            ...
            ("Find the file ‘notes.txt’ in my Documents folder", "retrieval"),
            ("Tell me something random about the ocean", "talk"),
            ("Search the web for cheap flights to Paris", "web"),
            ("Check if ‘budget.xlsx’ is on my drive", "retrieval"),
            ...
            ("Move all .jpg retrieval from Downloads to a ‘Photos’ folder", "retrieval"),
            ...
            ("Locate ‘meeting_agenda.docx’ in my system", "retrieval"),
            ...
            ("Check if the folder ‘Old_Projects’ exists on my desktop", "retrieval"),
            ...
            ("Find the file ‘vacation_itinerary.pdf’ on my drive", "retrieval"),
            ("Search the web for news on renewable energy", "web"),
            ("What’s the strangest thing you’ve learned recently?", "talk"),
            ("Organize all video retrieval into a ‘Videos’ folder", "retrieval"),
            ("Write a shell script to delete temporary retrieval", "code"),
            ("Hey, how’s your week been so far?", "talk"),
            ("Search online for the top movies of 2025", "web"),
            ("Locate ‘taxes_2024.xlsx’ in my Documents folder", "retrieval"),
            ...
            ("Check if ‘photo_backup.zip’ exists on my drive", "retrieval"),
            ("Write a Python script to rename retrieval with a timestamp", "code"),
            ...
            ("Move all .docx retrieval to a ‘Work’ folder", "retrieval"),
            ("I would like to make a new project called 'new_project'", "retrieval"),
            ("I would like to setup a new project index as mark2", "retrieval"),
            ...
            ("Setup a new flutter project called 'new_flutter_project'", "retrieval"),
            ("can you create a new project called 'new_project'", "retrieval"),
            ("can you make a simple web app that display a list of retrieval in my dir", "code"),
            ...
            ("can you find research.pdf in my drive", "retrieval"),
            ("hi", "talk"),
            ("hello", "talk"),
            ("What is the difference between supervised and unsupervised learning?", "retrieval"),
            ("Give me details about the transformer architecture in NLP.", "retrieval"),
            ("Summarize the concept of reinforcement learning.", "retrieval"),
            ("Explain how attention mechanisms work in neural networks.", "retrieval"),
            ("Find information on transfer learning techniques.", "retrieval"),
            ("What are the advantages of using vector embeddings?", "retrieval"),
            ("Retrieve data related to natural language understanding.", "retrieval"),
            ("Explain the concept of overfitting in machine learning.", "retrieval"),
            ("Get insights on diffusion models in generative AI.", "retrieval"),
            ("Find the explanation for gradient descent optimization.", "retrieval"),
            ("Give me a short overview of large language models.", "retrieval"),
            ("Retrieve knowledge about image recognition networks.", "retrieval"),
            ("Explain how RAG (Retrieval-Augmented Generation) works.", "retrieval"),
            ("Get me data on fine-tuning techniques in language models.", "retrieval"),
            ("Find details on how knowledge graphs are used in AI.", "retrieval"),
            ("Explain vector similarity search in simple terms.", "retrieval"),
            ("Retrieve information on multimodal AI systems.", "retrieval"),
            ("Find the document about machine learning basics that I uploaded.", "retrieval"),
            ("Retrieve the file named 'project_plan.pdf' from my documents.", "retrieval"),
            ("Show me what’s written in the 'research_summary.txt' file.", "retrieval"),
            ("Get all sections mentioning 'API integration' from my uploaded docs.", "retrieval"),
            ("Summarize the document that discusses vector databases.", "retrieval"),
            ("Look into my retrieval for anything about 'customer segmentation'.", "retrieval"),
            ("Retrieve the notes related to 'database optimization'.", "retrieval"),
            ("Find content inside my documents about 'team communication plan'.", "retrieval"),
            ("Summarize the PDF I uploaded yesterday about neural networks.", "retrieval"),
            ("Search my uploaded retrieval for mentions of 'security protocol'.", "retrieval"),
            ("Get all information from my drive about 'project architecture'.", "retrieval"),
            ("Retrieve the document titled 'system_overview.docx'.", "retrieval"),
            ("Summarize any uploaded notes on 'user interface design'.", "retrieval"),
            ("Find all documents that reference 'data extraction pipeline'.", "retrieval"),
            ("Get information from the file containing 'training logs'.", "retrieval"),
            ("Retrieve the section in my docs that explains 'evaluation metrics'.", "retrieval"),
            ("Search my data for references to 'prompt optimization'.", "retrieval"),
            ("Summarize the uploaded PDF about 'reinforcement learning'.", "retrieval"),
            ("Find the uploaded file that includes 'API endpoint list'.", "retrieval"),
            ("Get me all text snippets mentioning 'performance report'.", "retrieval"),
            ("Current dispute between thailand and combodia", "retrieval")
        ]
        random.shuffle(few_shots)
        texts = [text for text, _ in few_shots]
        labels = [label for _, label in few_shots]
